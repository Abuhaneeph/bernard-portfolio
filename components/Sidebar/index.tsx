      ...
      >
        <MotionStack variants={stagger} spacing={6} w="100">
          <MotionText
            ...
            fontWeight="light"
          >
            Knock Knock who is there ? <br></br>Welcome Anon I am
          </MotionText>
          <MotionHeading
            as="h1"
            size="2xl"
          ...
          >
            ...
            for taking the time to visit my personal website. I`m a web3 developer i create Dapps(Decentralized Applications),
            DeFi & NFTs.
            <Text variant="emphasis" as="span">
              {' '}
              WAGMI!!!.
