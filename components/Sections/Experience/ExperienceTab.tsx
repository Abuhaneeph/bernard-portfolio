...
const ExperienceTab = () => {
  ...
  const emphasis = useColorModeValue('teal.500', 'orange.300')
  const borderColor = useColorModeValue('gray.300', 'orange.200')
  const activeBordercolor = useColorModeValue('teal.500', '#e09b21')
