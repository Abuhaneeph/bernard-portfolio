  ...
  return (
    ...
    >
      ...
      <Text variant="description">
        In my spare time, I enjoy experimenting with new Web3 development tools, 
        in other to improve my development skills,I also enjoy socializing on twitter and speaking on twitter spaces
        . So please feel free to send me a message on any of
        my social media accounts or send me an{' '}
        <Link
          href="mailto:onuhbernard4@gmail.com"
          target="_blank"
          rel="noreferrer"
        >
          email
